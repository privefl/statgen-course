...
In practice, we know that LD between two genetic variants tend to decay with an increasing distance between them [@pritchard2001linkage]. In LDpred2 [@prive2020ldpred2], I assume that variants distant from more than 3 cM are uncorrelated (the case also for variants on different chromosomes). 
...
- computing LD from imputed data seem to provide an unbiased estimation [@prive2021identifying]

- should partial correlations be used instead? (e.g. when there is some population structure in the data)    
this is still an open question I want to investigate
