...
:::: {.infobox .caution}
There is no `$fam` information in this case, which should be read from other data and matched/joined using IDs from the *sample* file. From the BGEN, you can also use these IDs to read a subset of individuals only, as done [in this code](https://github.com/privefl/paper-misspec/blob/main/code/prepare-genotypes.R#L33-L34).
::::
