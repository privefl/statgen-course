...
Some example code to run a GWAS on multiple nodes on an HPC cluster:
...
Then, the intercept of LD score regression was used to test for confounding [@bulik2015ld]. 
However, it was observed that LD score regression intercepts tend to increase with SNP-heritability and GWAS sample size [@loh2018mixed].
